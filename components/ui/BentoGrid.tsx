...
export const BentoGrid = ({
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-1 md:grid-cols-6 lg:grid-cols-5 md:grid-rows-7 gap-4 lg:gap-8 max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8",
        className
      )}
    >
      {children}
...
export const BentoGridItem = ({
  ...
  const leftLists = ["React", "Tailwind", "CSS","SQL"];
  const rightLists = ["HTML", "Java", "JavaScript","Unity"];
        ...
        >
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              >
                <img src="/path/to/confetti.gif" alt="confetti" width={200} height={200} />
              </div>
